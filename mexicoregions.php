 ...
 */
function mexicoregions_stateConfig() {
  $config = array(
 ...
 *   Success true/false.
 */
function mexicoregions_loadProvinces() {
  $stateConfig = mexicoregions_stateConfig();
 ...
 */
function mexicoregions_civicrm_install() {
  mexicoregions_loadProvinces();
}
/**
 ...
 */
function mexicoregions_civicrm_enable() {
  mexicoregions_loadProvinces();
}
/**
 ...
 */
function mexicoregions_civicrm_upgrade($op, CRM_Queue_Queue $queue = NULL) {
  mexicoregions_loadProvinces();
}
